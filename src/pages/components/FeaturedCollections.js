...
import tablewareImg from '../../home-top-sect-new1.jpg'
...
const FeaturedCollections = (args) => {
    ...
    const [activeIndex, setActiveIndex] = useState(0);
  ...
  }}  className='featured-collection-product-img'   src={item.src} alt={item.altText} />
            <CarouselCaption
      ...
      return (
        ...
        <h1 className='finria-sans' style={{marginBottom:"22px"}}>Featured Collections</h1>
